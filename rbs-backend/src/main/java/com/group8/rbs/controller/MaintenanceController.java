...
public class MaintenanceController {
        ...
        try {
            ...
            if (!affectedBookings.isEmpty()) {
                int cancelledCount = maintenanceService.cancelBookingsForMaintenance(
                        affectedBookings, savedSchedule, emailServiceFactory);
    ...
    public ResponseEntity<?> releaseFacilityFromMaintenance(@PathVariable Long facilityId) {
        try {
            ...
            Optional<MaintenanceSchedule> currentMaintenance = maintenanceService
                    .getCurrentMaintenanceForFacility(facilityId);
            ...
            MaintenanceSchedule updatedSchedule = maintenanceService
                    .updateMaintenanceEndDate(schedule.getMaintenanceId(), today);
