...
public class MaintenanceServiceTest {
        ...
        void cancelBookingsForMaintenanceShouldCancelAffectedBookingsAndRefundCredits() throws MessagingException {
                ...
                when(emailServiceFactory.getEmailService("resendEmailService")).thenReturn(mockEmailService);
                ...
                int result = maintenanceService.cancelBookingsForMaintenance(
                                affectedBookings, maintenanceSchedule, emailServiceFactory);
                ...
                verify(mockEmailService).sendEmail(eq("test@example.com"), anyString(), anyString());
        ...
        void cancelBookingsForMaintenanceShouldHandleEmptyBookingsList() throws MessagingException {
                ...
                // Stub the factory to return the mock email service
                when(emailServiceFactory.getEmailService(anyString())).thenReturn(mockEmailService);

                // Act
                int result = maintenanceService.cancelBookingsForMaintenance(
                                Collections.emptyList(), maintenanceSchedule, emailServiceFactory);
        ...
        void cancelBookingsHandlesEmailSendingFailure() throws MessagingException {
                ...
                // Mock email service and factory behavior
                EmailService mockEmailService = mock(EmailService.class);
                when(emailServiceFactory.getEmailService(anyString())).thenReturn(mockEmailService);
                ...
                verify(mockEmailService).sendEmail(anyString(), anyString(), anyString());
        }
        ...
        void cancelBookingsHandlesEmailException() throws MessagingException {
                ...
                // Mock email service and factory
                EmailService mockEmailService = mock(EmailService.class);
                when(emailServiceFactory.getEmailService(anyString())).thenReturn(mockEmailService);
                ...
                // Should return 0 due to email exception
                assertEquals(0, result);
                ...
                // Verify email send was attempted and threw
                verify(mockEmailService).sendEmail(anyString(), anyString(), anyString());
        }
        ...
        void cancelBookingsShouldHandleCreditRefundFailure() throws MessagingException {
                ...
                // Should still return 1 since email was sent successfully
                assertEquals(1, result);

                // Verify booking was cancelled and saved
                assertEquals(BookingStatus.CANCELLED, testBooking.getStatus());
                verify(bookingRepository).save(testBooking);

                // Verify credit refund was attempted
                verify(creditService).addCredits(eq(1L), any(Integer.class));
        ...
        void checkMaintenanceStatusBatchShouldHandleRepositoryExceptions() {
                ...
                // All facilities should be marked as not under maintenance when exception
                // occurs
                assertFalse(result.get("1"));
                assertFalse(result.get("2"));
                assertFalse(result.get("3"));
        ...
        void hasOverlappingMaintenanceShouldHandleAdjacentButNonOverlappingPeriods() {
                ...
                // Create new maintenance starting on the next day (adjacent but not
                // overlapping)
        ...
        void cancelBookingsShouldHandleNoCreditsToRefund() throws MessagingException {
                ...
                int result = maintenanceService.cancelBookingsForMaintenance(
                                Arrays.asList(bookingWithInvalidTimeSlot), maintenanceSchedule, emailServiceFactory);
